...
unless asterisk is specified.
The selection list MAY include any numeric,
...
The BOOLEAN data type maps to the corresponding \verb:boolean: data type is defined in the \DALIspec.
...
\end{verbatim}
\noindent
%TODO - speculative, not definitive.
...
\begin{itemize}
    \item Changes from WD-ADQL-2.1-20160502
        \begin{itemize}
            ...
            \item Expanded the data types to add sub-section for each xtype\\
