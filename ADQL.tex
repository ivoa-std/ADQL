...
The COORDSYS function extracts the coordinate system string value from a given
geometry.

The following example would extract the coordinate system of a POINT literal:
\begin{verbatim}
    COORDSYS(
        POINT(
            25.0,
...
The coordinate system could also be extracted from a column containing a
geometry data type:
\begin{verbatim}
    COORDSYS(
        t.circle
