...
\begin{itemize}
    ...
    \item 20171129-002 Add text to describe 'preferred crossmatch method'

    \item 20171129-003 Now that we allow polymorphism, do we need to deprecate
    the coordsys param for BOX, CIRCLE AND POLYGON? \SectionSee{sec:geom.coordsys.param}

    \item 20171129-004 Should support for REGION be optional? \SectionSee{sec:types.geom.region}
    \item 20171129-005 Should we add a literal constructor for REGION? \SectionSee{sec:types.geom.region}

    \item 20171129-006 The description of BOX has known issues, particularly its
    behaviour close to the poles. \SectionSee{sec:functions.geom.box}
...
\begin{itemize}
    ...
    \item Changes from WD-ADQL-2.1-20171024
        \begin{itemize}
            \item Imported changes for MOD, RAND, ROUND and TRUNCATE from ADQL-2.0 Erratum 2\\
            (svn version xxxx, 29 Nov 2017)
