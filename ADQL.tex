...
To support strings which are generated when a query is executed,
...
in detail in Section \ref{sec:functions.geom.region}, this construct is a general purpose function and
