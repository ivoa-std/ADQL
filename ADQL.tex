...
first followed by \verb:TOP: (see \SectionRef{sec:offset}). 
...
ADQL declares a list of reserved keywords (see \SectionRef{sec:keywords}) which include
...
concepts from the \STCSspec data model.
...
(See \ref{sec:geom.coordsys.param}).
...
ADQL also provides a place holder to define user specific functions. Such
